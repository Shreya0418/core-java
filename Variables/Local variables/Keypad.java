class Keypad {
  public static void main(String[] args) {
    ...
    int price = 599;   // you can change price if needed
    String brand = "HP";
    String model = "K120";
    String color = "Black";
    String formFactor = "Keyboard";
    String powerSource = "Corded Electric";
    String itemWeight = "400 g";
    String dimensions = "43.6 x 14 x 2.5 cm";
    String manufacturer = "HP India Sales Pvt. Ltd.";
    String countryOfOrigin = "China";
    String warranty = "3 Years RTB Warranty";
    String components = "USB Keyboard";
